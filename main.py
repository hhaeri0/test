...
def main():
    ...
    st.set_page_config(page_title="교육과정", page_icon="🏫")  # 웹 페이지 제목과 아이콘 설정
    st.image('climate.png')  # 상단에 이미지를 표시
    st.title("_:red[2022 개정교육과정 알아보기]_ 🏫")  # 제목 표시 (2022 개정 교육과정 알아보기)
